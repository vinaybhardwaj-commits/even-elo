      ...
      <main className="max-w-[1400px] mx-auto px-8 py-8">
        ...
        <div className="flex items-end justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            <Link href="/admin/vcs" className="btn-ghost text-sm">
              + Add VC
            </Link>
            <button
              ...
              {!loading && sorted.length === 0 && (
                <tr>
                  <td colSpan={10} className="px-4 py-12 text-center text-sm text-stone-500">
                    {data?.rows.length === 0
                      ? "No VCs yet have a score snapshot. Add VCs in /admin/vcs and record cases via /input/cases."
              ...
              {!loading &&
                sorted.map((r, i) => (
                  <tr
                    ...
                    onClick={() => (window.location.href = `/vc/${r.vc_id}`)}
                  >
