      ...
      {counts && (
        <>
          <div className="grid grid-cols-4 gap-4 mb-6">
            <StatCard label="Visiting Consultants" value={counts.vcs_active} caption={`${counts.vcs_total} total`} href="/surgical-elo/admin/vcs" />
            ...
            <StatCard label="Audit entries" value={counts.audit_log_total} caption="all time" href="/surgical-elo/admin/audit" />
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="card p-5 bg-white border border-stone-200 rounded-xl">
              ...
              <Link
                href="/surgical-elo/admin/weights"
          ...
          <div className="mt-8">
            ...
            <div className="grid grid-cols-3 gap-3">
              <QuickLink href="/surgical-elo/admin/vcs" title="VC roster" desc="Add, edit, suspend Visiting Consultants" />
              <QuickLink href="/surgical-elo/admin/positions" title="Positions" desc="9 stamping roles for audit defensibility" />
              <QuickLink href="/surgical-elo/admin/audit" title="Audit log" desc="Append-only record (ships in ELO.7)" />
            </div>
          </div>
        </>
      )}
