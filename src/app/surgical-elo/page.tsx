        ...
        <div className="flex items-end justify-between mb-6">
          <div>
            ...
            <h1 className="text-3xl font-semibold tracking-tight">
              Visiting Consultant Leaderboard
            </h1>
            <p className="text-sm text-stone-500 mt-2 num">
              ...
              {data
                ...
                : "…"}{" "}
              observations in last 6mo · Composite ELO weighted{" "}
              {data?.weights
          ...
          <div className="flex items-center gap-2">
            <Link href="/surgical-elo/admin/vcs" className="btn-ghost text-sm">
              + Add VC
            </Link>
            <button
          ...
          <table className="w-full">
            <thead>
              <tr className="text-left text-[11px] font-medium text-stone-500 tracking-wider uppercase border-b border-stone-200 bg-stone-50">
                ...
                <SortableTh label="ELO" k="composite" sortKey={sortKey} sortDir={sortDir} onClick={toggleSort} className="text-right w-24" />
              ...
              {!loading && sorted.length === 0 && (
                <tr>
                  <td colSpan={10} className="px-4 py-12 text-center text-sm text-stone-500">
                    {data?.rows.length === 0
                      ? "No VCs yet have a score snapshot. Add VCs in /surgical-elo/admin/vcs and record cases via /surgical-elo/input/cases."
              ...
              {!loading &&
                sorted.map((r, i) => (
                  <tr
                    ...
                    onClick={() => (window.location.href = `/surgical-elo/vc/${r.vc_id}`)}
                  >
